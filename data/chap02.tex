...
\begin{figure}[htbp]
  ...
  \begin{subfigure}{1\textwidth}
    \centering
    \includegraphics[width=0.6\textwidth]{sda_example_1}
    \caption{\label{fig:sda_example_1}}
  \end{subfigure}
  \begin{subfigure}{1\textwidth}
    \vspace{1em}
    \centering
    \includegraphics[width=0.6\textwidth]{sda_example_2}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}{1\textwidth}
    \centering
    \includegraphics[width=0.6\textwidth]{nfc_example_1}
    \caption{\label{fig:nfc_example_1}}
  \end{subfigure}
  \begin{subfigure}{1\textwidth}
    \vspace{1em}
    \centering
    \includegraphics[width=0.6\textwidth]{nfc_example_2}
