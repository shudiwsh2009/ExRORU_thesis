...
\begin{figure}[htbp]
  ...
  \begin{subfigure}{1\textwidth}
    ...
    \begin{minipage}[b]{1\textwidth}
      \centering
      \includegraphics[width=0.7\textwidth]{invisible_transition_a_1}
    \end{minipage}
    \begin{minipage}[b]{1\textwidth}
      \vspace{1em}
      \centering
      \includegraphics[width=0.7\textwidth]{invisible_transition_a_2}
    \end{minipage}
    \caption{}
  ...
  \begin{subfigure}{1\textwidth}
    ...
    \begin{minipage}[b]{1\textwidth}
      \vspace{1em}
      \centering
      \includegraphics[width=0.7\textwidth]{invisible_transition_b_1}
    \end{minipage}
    \begin{minipage}[b]{1\textwidth}
      \vspace{1em}
      \centering
      \includegraphics[width=0.7\textwidth]{invisible_transition_b_2}
    \end{minipage}
    \caption{}
  ...
  \begin{subfigure}{1\textwidth}
    ...
    \begin{minipage}[b]{1\textwidth}
      \vspace{1em}
      \centering
      \includegraphics[width=0.7\textwidth]{invisible_transition_c_1}
    \end{minipage}
    \begin{minipage}[b]{1\textwidth}
      \vspace{1em}
      \centering
      \includegraphics[width=0.7\textwidth]{invisible_transition_c_2}
    \end{minipage}
    \caption{}
